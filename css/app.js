$(document).ready(function(){
  ...
  $('.ubicanos-dropdown').hover(function(){
    ...
    //Zoom
    $('div.glass-zoom').zoom({magnify: 0.8});
    $('div.glass-zoomBig').zoom({magnify: 1.2});
    // Rating
    $(".rating").rate();
...
$('#glass3').click(function(){
  $(".glass-zoomBig img").attr('src',"img/glass-thumb3.png");
});